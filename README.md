...
| Final grasp | `visualizations/final_grasp_diagnostics.png`<br><img src="docs/media/lamp_wsg50_readme_clean/final_grasp_diagnostics.png" width="260" alt="Final grasp diagnostic projections"> | XY/XZ/YZ diagnostic projections with opening, target-distance, and surface-distance checks. |
